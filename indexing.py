...
def create_index_spimi(document_files, preprocess, output_filepath,
    ...
    while not is_exhausted:
        filename, is_exhausted = __spimi_invert(token_stream,
    ...
    __merge_spimi_blocks(block_filenames, output_filepath)
...
def __merge_spimi_blocks(block_filepaths, output_filepath):
